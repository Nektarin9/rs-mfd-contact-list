...
export class ApiContacts {
    ...
    public static getContactById(id: string) : Promise<AxiosResponse<ApiGetContactsType>> {
    ...
    public static getGroupContactById(id: string) : Promise<AxiosResponse<ApiGetGroupContactsType>> {
        return backendApiAxios.get(`${GROUP_CONTACTS}/${id}`);
    }
    public static patchFavoriteContacts(isFavorit: boolean, id: string) : Promise<AxiosResponse<ApiGetContactsType>> {
